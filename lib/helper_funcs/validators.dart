...
String? passwordValidator(String? value){
  String reg = r'^(?=.*[0-9])(?=.*[a-z])(?=.*[A-Z])(?=.*[@#$%^&-+=()])(?=\\S+$).{8, 20}$';
  if ((value as String).isEmpty) return 'Must not be empty';
  String errMessage = 'Password rules: must be between 8 and 20 cahracters, least one number, upper case and lowercare letter, oen special character, no spaces';
